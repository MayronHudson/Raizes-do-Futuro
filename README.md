...
**Raízes do Futuro** é um site institucional fictício de uma organização dedicada à preservação ambiental, educação ecológica e projetos de voluntariado. O objetivo do site é apresentar informações sobre os projetos, incentivar voluntariado e exemplificar boas práticas de desenvolvimento web.
...
- Elementos semânticos e acessíveis  
